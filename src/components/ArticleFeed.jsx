      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        {posts.map((post, i) => (
          <article 
            id={`article-${post.id}`}
            key={post.id} 
            className="group flex flex-col premium-card p-0 bg-white/5 border-white/10 rounded-3xl overflow-hidden hover:-translate-y-2 transition-transform duration-700"
          >
            {/* Image Section */}
